...
const Button = ({ text, color, width, to, type, disabled }) => {
  const colorStyles = {
  ...
  const baseClasses = `relative inline-block ${width} py-3 px-5 rounded-t-[20px] rounded-bl-[20px] font-bold text-center overflow-hidden border transition-colors duration-300 ease-in-out group ${
